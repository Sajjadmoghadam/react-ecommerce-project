        ...
        <>
            ...
            <Stack direction={'row'} padding={'12px'} justifyContent={"space-between"} zIndex={2} sx={{ backgroundColor: 'transparent', position:"absolute" , top:"0",left:"0",right:"0"}}>
                ...
                <Stack direction={'row'} spacing={3}>
                    <Button color='inherit' sx={{ fontSize: '12px', display: { md: 'block', xs: 'none' } }}><Link href="/faq" color="inherit" underline='none'> سوالات متداول</Link></Button>
                    <Button color='inherit' sx={{ fontSize: '12px', display: { md: 'block', xs: 'none' } }}><Link href="/application" color="inherit" underline='none'>دانلود اپلیکیشن</Link></Button>
